...
INCS = $(TEMPLATES)/menu.txt $(TEMPLATES)/chap_menu.txt $(TEMPLATES)/lang_menu.txt
...
$(TEMPLATES)/lang_menu.txt: $(TEMPLATES)/lang_chapter_binary.txt
	./gen_lang_menu.awk <$(TEMPLATES)/lang_chapter_binary.txt >$(TEMPLATES)/lang_menu.txt

$(TEMPLATES)/lang_chapter_binary.txt: $(TEMPLATES)/chapters.txt $(TEMPLATES)/langs.txt
	./gen_lang_bin.sh < $(TEMPLATES)/chapters.txt >$(TEMPLATES)/lang_chapter_binary.txt
	
$(TEMPLATES)/chap_menu.txt: $(TEMPLATES)/chapters.txt
