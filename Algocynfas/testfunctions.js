...
function addRoot(value)
{
    ...
    // var group=new fabric.Group([x,text],{originX:'center',originY:'center',left:width/2,top:radius});
    canvas.add(x);
    canvas.add(text);
    return x;
...
function addNode(node1,node2,angle)
{
    ...
    console.log(initiallinex);
    console.log(initialliney);
    console.log(finallinex);
    console.log(finalliney);
