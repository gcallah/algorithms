module RedBlackTrees
  class Node
    attr_accessor :key, :satellite_data, :color, :p, :left, :right
    def initialize(key, satellite_data, color, p, left, right)
      @key, @satellite_data, @color, @p, @left, @right = key, satellite_data, color, p, left, right
    end
